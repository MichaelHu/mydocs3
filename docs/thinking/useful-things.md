...
* `SAP系统`: Systems Applications and Products，SAP是全球企业管理软件与解决方案的技术领袖，同时也是市场领导者。SAP系统是一种**ERP软件**。
...
* `Ontology`，`本体论`，研究客观事物存在的本质，它与`认识论`（`Epistemology`）相对。认识论研究人类知识的本质和来源。总的来说，本体论研究`客观存在`，认识论研究`主观认知`
* `ontology`，本体
