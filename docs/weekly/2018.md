...
* [ 181216 ] 关于依赖注入（typescript）<https://juejin.im/post/5c16004ae51d45485a098ef8> [from 海亮]

> JS

* [ 181227 ] 你真的了解前端模块化吗？ <https://www.infoq.cn/article/QdLtxgNU63-AuY1VOSm7> 前端模块化发展的各个阶段介绍，内容较全：CommonJS, AMD, ES6, CMD等
* [ 181224 ] 详解javascript拖拽（一）基础介绍 <https://juejin.im/post/5c20b9d9e51d452f2c2ef152> [from 海亮]
* [ 181224 ] 详解javascript拖拽（二）拖拽的应用及示例 <https://juejin.im/post/5c20bd25f265da616f6ffac1> [from 海亮]
* [ 181226 ] 一文读懂前端缓存 <https://juejin.im/post/5c22ee806fb9a049fb43b2c5> [from 海亮]
* [ 181227 ] 5 款工具助力 React 快速开发 <https://juejin.im/post/5c242e3f51882573d90678ad> [from 海亮]
* [ 181227 ] 你真的了解前端模块化吗？ <https://www.infoq.cn/article/QdLtxgNU63-AuY1VOSm7> 前端模块化发展的各个阶段介绍，内容较全：CommonJS, AMD, ES6, CMD等 [from 大民]
* [ 181225 ] 移动端的那些坑 <https://mp.weixin.qq.com/s/pVGFcVWmn5o-tD6hrdksUQ> [from 文玲]
* [ 181225 ] 微信自研 APM 利器，Matrix 正式开源了 <https://mp.weixin.qq.com/s/muX_RgK3cXiMd4j2B0L_lA> [from 大瑞]
* [ 181214 ] 前端 Vue.js 快速开发微信小程序，基于 Vue 的小程序开发框架：Megalo发布！<https://mp.weixin.qq.com/s/fCWKniSNX4GFSPA6rO7Dtw> [from 思源]

> 开源项目&工具

* [ 181221 ] jieba - 开源中文分词工具，支持Python、nodejs、java、go等各种语言，可API编程、可命令行 <https://github.com/fxsjy/jieba> <iframe src="http://258i.com/gbtn.html?user=fxsjy&repo=jieba&type=star&count=true" frameborder="0" scrolling="0" width="105px" height="20px"></iframe>
* [ 181228 ] `walle` - 瓦力：开源项目代码部署平台 <https://github.com/meolu/walle-web> <iframe src="http://258i.com/gbtn.html?user=meolu&repo=walle-web&type=star&count=true" frameborder="0" scrolling="0" width="105px" height="20px"></iframe>
* [ 181228 ] matrix - Matrix is a plugin style, non-invasive APM system developed by WeChat. <https://github.com/tencent/matrix>

> 资讯

* [ 181225 ] Electron 4.0 稳定版发布，集成 Node 10 和 Chromium 69 <https://www.infoq.cn/article/5*2be4HwRdesZcsFuTjv>
* [ 181227 ] 中国北斗系统今天开始提供全球服务！ <https://www.toutiao.com/a6639566993013867012/>
* [ 181226 ] 说好的敬畏每一行代码呢？`Antd` 代码彩蛋炸翻一圈人 <https://www.infoq.cn/article/Watxs-KBNJRpYF3BcGuJ>
...
* [ 181220 ] `Glider.js` - A blazingly fast, crazy small, fully responsive, mobile-friendly, dependency free, native scrolling list with paging controls! <https://nickpiscitelli.github.io/Glider.js/> 又一个Carousel的实现 
* [ 181213 ] Cache API 101 <https://bitsofco.de/cache-api-101/> The cache API was created as part of the service worker specification to “allow authors to fully manage their content caches for offline use”. 
* [ 181212 ] Performance Anti-Patterns: Base64 Encoding <https://calendar.perfplanet.com/2018/performance-anti-patterns-base64-encoding/> Base64是一种`反模式`
...
* [ 181214 ] 计算机视觉入门 之初识 opencv.js <https://jdc.jd.com/archives/212806>
* [ 181213 ] 2018 年前端技术总结 <https://zhuanlan.zhihu.com/p/52278495> `趋势`：前端 == 全端；前端框架趋于平稳；函数式编程；自家组件库；对Nodejs使用更为理智。补充数据可视化方面：AntV系列( G2, G6, L7 )、3D渲染( Three.js, ClayGL )、GIS 3D( L7, Uber Ketoper.gl, Cesium )等
* [ 170222 ] 函数式编程入门教程 <http://www.ruanyifeng.com/blog/2017/02/fp-tutorial.html>
    * 与面向对象编程（Object-oriented programming）和过程式编程（Procedural programming）并列的编程范式。
    * 最主要的特征是，函数是第一等公民。
    * 强调将计算过程分解成可复用的函数，典型例子就是map方法和reduce方法组合而成 MapReduce 算法。
    * 只有`纯的、没有副作用`的函数，才是合格的函数。
    上面这些说法都对，但还不够，都没有回答下面这个更深层的问题。
* [ 2016 ] JS函数式编程指南 - gitbook <https://llh911001.gitbooks.io/mostly-adequate-guide-chinese/content/>
* [ 181220 ] “阿波罗“登月中的工程管理一瞥 <https://mp.weixin.qq.com/s/-u0TtSBA5EynVpTkuSVdog>
* [ 181219 ] 钉钉刺痛腾讯 ! <http://api.woshipm.com/it/1756021.html> 如果让人选择企业im，员工也许会喜欢企业微信，但是老板一定会选择钉钉。但问题是，谁才是决策者呢？
* [ 181214 ] 微软早不是那个微软了 <https://mp.weixin.qq.com/s/1aPWh2AL3pJRWkqHdmYFqg>
* [ 181217 ] 你未必知道的CSS故事：揭开leading的面纱 <https://mp.weixin.qq.com/s/CsETZ7Ad3vkDpIo6zDufFg>
...
* [ 181210 ] 连约会都能替你完成：十年后，`数字替身`可以决定你的人生？ <https://mp.weixin.qq.com/s/pKquK0C8Dc2CtrThUSoizQ> [from 大瑞] 外卖收集你的口味，淘宝收集你的爱好，微信收集你的朋友圈，搜索引擎收集你的问题，新闻app收集你的关注点
* [ 181206 ] Microsoft Edge: Making the web better through more open source collaboration <https://blogs.windows.com/windowsexperience/2018/12/06/microsoft-edge-making-the-web-better-through-more-open-source-collaboration/> 微软在蜕变的路上一去不返
* [ 181203 ] 7.2.0 Released: Private Instance Methods <https://babeljs.io/blog/2018/12/03/7.2.0>
        // 看点1 - Private Instance Methods
        class Person {
          #age = 19;
...
* [ 181214 ] jsPDF - <https://github.com/MrRio/jsPDF> <iframe src="http://258i.com/gbtn.html?user=MrRio&repo=jsPDF&type=star&count=true" frameborder="0" scrolling="0" width="105px" height="20px"></iframe>
* [ 181204 ] QUIC and HTTP/3 : Too big to fail?! <https://calendar.perfplanet.com/2018/quic-and-http-3-too-big-to-fail/> 
* [ 181127 ] Inside Fiber: in-depth overview of the new reconciliation algorithm in React <https://medium.com/react-in-depth/inside-fiber-in-depth-overview-of-the-new-reconciliation-algorithm-in-react-e1c04700ef6e> 关于React Fiber的深度文章

        // React.createElement生成的数据结构
        [
            {
...
* [ 181206 ] 【人物志】技术十年：美团第一位前端工程师潘魏增 <https://tech.meituan.com/renwuzhi_panweizeng.html>
* [ 181206 ] Top 10 Algorithmia Blog Posts of 2018 <https://blog.algorithmia.com/top-10-algorithmia-blog-posts-of-2018/> 关于机器学习方面的Top10文章，关于人脸识别、情绪识别等
    1. No.1 [ 180410 ] Convolutional Neural Nets in `PyTorch` <https://blog.algorithmia.com/convolutional-neural-nets-in-pytorch/>
    2. ...
* [ 181206 ] This year in JavaScript: 2018 in review and npm’s predictions for 2019 <https://blog.npmjs.org/post/180868064080/this-year-in-javascript-2018-in-review-and-npms> 来看看2019预测部分：
    1. 将会弃用一种当前使用的工具，js的世界中，框架和工具都不是持久的，不变的是变化。3-5年的流行度已经是巅峰
    2. 虽然React的增长放缓，但其仍然是绝对的主流，仍占据60%的市场份额 
    3. 可能需要学习一下`GraphQL`了，或许可以在新项目中使用
    4. `Typescript`，被调查者中，46%的使用率，表明这不仅是一时的对工具的热情，它是一种新的语言趋势
* [ 181204 ] Flutter 1.0: Google’s Portable UI Toolkit <https://developers.googleblog.com/2018/12/flutter-10-googles-portable-ui-toolkit.html>
    * 10个月前，发出了第一版，目前已有数千的基于Flutter开发的iOS和Android应用
    * Animations built with Flare can be embedded into an existing Flutter app as a widget
* [ 181212 ] `styled-components` <https://github.com/topics/styled-components>
* [ 181207 ] Dust3D - <https://dust3d.org> github: <https://github.com/huxingyi/dust3d> 开源3D建模工具
* [ 181210 ] 8 张图帮你一步步看清 async/await 和 promise 的执行顺序 <https://mp.weixin.qq.com/s/2fnJADWMneTg6Zxl_oVahA> 浏览器的eventloop与node环境下的eventloop存在差异
...
* [ 181205 ] `Balloon.css`: Simple tooltips made of pure CSS github <https://github.com/kazzkiq/balloon.css> [from 君毅] Balloon.css lets you add tooltips to elements without JavaScript and in just a few lines of CSS 纯css实现的tooltip
* [ 181207 ] `pretty-checkbox` - A pure CSS library to beautify checkbox and radio buttons. <https://github.com/lokesh-coder/pretty-checkbox>
* [ 181201 ] 总结：如何修改美化radio、checkbox的默认样式 <https://segmentfault.com/a/1190000017209163> 使用原生的checkbox或input标签，在其后面设置相关联的label元素。给input元素设置为透明，然后通过定位让用户看到的是元素，利用css的原生属性来判断用户的操作，设置选中后的label样式
* 【译】8 个 Tips 让你更好的进行 Code Review <https://elevenbeans.github.io/2018/11/14/8-tips-for-great-code-reviews/>
* [ 181204 ] `Slate`: 一个完全可定制的富文本编辑框架 github https://github.com/ianstormtaylor/slate  [from 君毅]
    在 React 和 Immutable 基础上实现的一种可灵活扩展自定义化的编辑器框架；具备各种小而可复用的扩展插件；数据模型还可以支持协同编辑这种模式
* [ 180821 ] 通过 Recompose 库掌握 React 函数组件 https://zhuanlan.zhihu.com/p/42494044 [from 君毅]
    结合实际例子介绍了通过 Recompose 库来更高效的进行高阶组件式开发
    github: <https://github.com/acdlite/recompose>

* [ 181127 ] How to balance full-time work with creative projects <https://thecreativeindependent.com/guides/how-to-balance-full-time-work-with-creative-projects/>
* [ 181121 ] 5 Lessons Learned From Writing Over 300,000 Lines of Infrastructure Code <https://blog.gruntwork.io/5-lessons-learned-from-writing-over-300-000-lines-of-infrastructure-code-36ba7fadeac1> DevOps is in the stone ages - 仍处于石器时代
    1. The Production-Grade Infrastructure Checklist
    2. the toolset
    3. large modules considered harmful: slow, insecure, risky, hard to understand, hard to test, hard to review
            10 lines of code = 10 issues.
            500 lines of code = "looks fine."
    4.  infrastructure code without automated tests is broken: unit tests, integration tests, e2e( end-to-end ) test
        * unit tests - individual module ( 1-20 minutes )
        * integration tests - multiple modules ( 5-60 minutes )
        * e2e tests - entire stack ( 30-120+ minutes )
    5. the release process 
* [ 181205 ] HTTP/3详解 <https://http3-explained.haxx.se/zh/> 解决TCP对头阻塞问题（丢包率高的情况下，HTTP/2反而比HTTP/1性能低下）；基于UDP；详细工作原理
* [ 181130 ] Taro深度开发实践 <https://aotu.io/notes/2018/11/30/taro_practice/index.html>
* [ 181202 ] 妻子去世7个月，94岁老布什也走了：我爱你，直到死亡将我们分开…… <https://mp.weixin.qq.com/s/PU5xxMPNy2lMGCIVO6D-IA>
* [ 181203 ] 美国人是如何登月的？完整动画了解阿波罗飞船是如何运作的 <https://www.365yg.com/a6630610781010395652>
* [ 181206 ] TensorFlow内核剖析 - 关于TensorFlow内核工作原理的开源书籍。并非讲述如何使用 TensorFlow 构建机器学习模型，也不包含应用TensorFlow的最佳实践 <https://github.com/horance-liu/tensorflow-internals>
...
* [ 181129 ] ES6核心特性 <https://mp.weixin.qq.com/s/MghF85KhDPBSdaE1GXWjQg>
...
* [ 181129 ] 平庸前端码农之蜕变 — AST <https://juejin.im/post/5bfc21d2e51d4544313df666> [ from 荣婉如 ]
* [ 181108 ] 你所不知道的 CSS 阴影技巧与细节 <https://juejin.im/post/5be1023951882516fd36a38e> [ from 荣婉如 ]
* [ 181112 ] Why React Hooks, and how did we even get here? <https://medium.freecodecamp.org/why-react-hooks-and-how-did-we-even-get-here-aa5ed5dc96af>

    <img src="./img/react-hooks-181130.png" style="max-height:300px">
    
* [ 181124 ] 第二届Vue.js开发者大会 <https://vue.w3ctech.com>
    * Vue.js作者谈：Vue 3 最新进展 <https://www.bilibili.com/video/av36787459/> 底层优化，带来很多性能的提升，值得细看。
        * Compile Output的精细化控制
        * 不再使用Object.defineProperty()
        * ...
    * What I Learned from Maintaining Vue CLI <https://img.w3ctech.com/What-I-Learned-from-Maintaining-Vue-CLI.pdf>
        ...
        * ...
* [ 180621 ] 阿奇霉素6大注意事项，千万要记住 <https://m.sohu.com/a/237061011_464392/?pvid=000115_3w_a> 不要和复方甘草片一块吃、心律失常患者必须慎用、可能导致耳鸣或听力受损
* [ 150308 ] firefox修改user-agent <http://www.cnblogs.com/oceanking/p/4321304.html>
* [ 2012 ] Chrome 总是崩溃的原因可能是什么？ <https://www.zhihu.com/question/19834407> 插件、Flash插件、本文所说的Web Filter、操作系统漏洞等。GB问题正是遇到Web Filter相关的问题
* [ 180627 ] 微软累积更新：已修复Chrome崩溃无法正常工作问题 <https://m.sohu.com/a/238093274_223764> Windows 10系统，67.0.3396.79及以上版本受影响。不过Edge浏览器基本可以取代Chrome浏览器了
* [ 171011 ] 图解HTTP状态码的含义 <https://jszbug.com/illustrating-the-meaning-of-http-status-codes.html>
* [ 160125 ] 图解HTTP - HTTP状态码 <https://www.jianshu.com/p/305d0c4cc853>
...
* [ 181114 ] 使用 Chrome 原生 lazyload 属性进行图片懒加载：<http://suo.im/4VBhsD>，chrome 70 也需要通过实验标签开启 `chrome://flags/#enable-lazy-image-loading`
        <img src="..." lazyload="auto/on/off">
* [ 181123 ] Web 安全开发规范手册 V1.0 <https://mp.weixin.qq.com/s/KKXs_KkwhJ_TM2bz7KbM2Q>
* [ 181123 ] 原有vue项目接入typescript <https://mp.weixin.qq.com/s/a0p2-c9oLoOAL1mx80kqPw>
...
* [ 181122 ] 谷歌发布新的 Node.js Web 渲染界面 `Carlo` <https://www.infoq.cn/article/9DjiY0VW8hJ9ArwGE_L7>
* [ 181123 ] carlo - Web rendering surface for Node applications <https://github.com/GoogleChromeLabs/carlo>
* [ 181120 ] 2018 年 JavaScript 生态圈调查报告出炉！<https://www.infoq.cn/article/HS9HANIdb5SU_tINr1HA> 语言、框架、数据层、后端工具、测试、移动及桌面应用、其他
* [ 181110 ] Goodbye Electron, Hello `Desktop PWAs` <https://medium.com/dailyjs/goodbye-electron-hello-desktop-pwas-f316b8f39882>
* [ 181112 ] Faster async functions and promises <https://v8.dev/blog/fast-async>

    We made async functions faster thanks to two significant optimizations:
    1. the removal of `two extra microticks`, and
    2. the `removal of the throwaway promise`.

    And we also have `some nice performance advice` for JavaScript developers:
    1. favor async functions and await over hand-written promise code, and
    2. stick to the native promise implementation offered by the JavaScript engine to benefit from the shortcuts, i.e. avoiding two microticks for await.
...
* [ 181113 ] React Conf recap: `Hooks`, `Suspense`, and `Concurrent Rendering` <https://reactjs.org/blog/2018/11/13/react-conf-recap.html> 2018 React Conf概要重述



## 181112-181116

* [ 181115 ] 前端黑科技：美团网页首帧优化实践 <https://mp.weixin.qq.com/s/20yJV3D8SeI-cM0PCqTDAQ>
* [ 181109 ] 重磅｜百度称将接管调整海淀区红绿灯 可减少40%等待时间！ <https://mp.weixin.qq.com/s/B_dFfbv0PBtpn1u0J6s6WQ>
* [ 181112 ] 技术领导力就是“成事”的能力 <https://mp.weixin.qq.com/s/tHfwkzR0lTtlgcX5EivlEQ>
* [ 181112 ] 一个活了 45 年的「愚蠢」 Bug！ <https://mp.weixin.qq.com/s/C6Qhs0zQXprJ4oLyYlGfEw> Dos时代到Windows，以下这些文件名表示设备，不能当作普通文件名：`CON, PRN, AUX, NUL, COM1, COM2, COM3, COM4, COM5, COM6, COM7, COM8, COM9, LPT1, LPT2, LPT3, LPT4, LPT5, LPT6, LPT7, LPT8, LPT9`
* [ 181116 ] 最简单易懂的10堂算法入门课——算法思想之三：动态规划 <https://m.toutiao.com/column/v2/index/text_article/landing/?article_id=6622158040575509000&tt_from=weixin&utm_source=weixin&utm_medium=toutiao_ios&utm_campaign=client_share&wxshare_count=1>
* [ 181107 ] Facebook 智能 bug 修复神器：让程序员少掉几根头发 <https://www.infoq.cn/article/yd-b2NvHMWPhpSwl7kqD> `Getafix`: How Facebook tools learn to fix bugs automatically <https://code.fb.com/developer-tools/getafix-how-facebook-tools-learn-to-fix-bugs-automatically/>
* [ 181113 ] 在 Linux 中怎么运行 MS-DOS 游戏和程序 <https://www.toutiao.com/a6623153718294479368>
* [ 181113 ] 理解 JavaScript 中的高阶函数 <https://mp.weixin.qq.com/s/RMfTOnELywi0W-qyrmU0WQ>
* [ 180820 ] 使用 React 与 Vue 创建同一款 App，差别究竟有多大？ <https://www.toutiao.com/a6591729687167238659/>
* [ 181115 ] Sed 命令完全指南 <https://www.toutiao.com/a6623975827228852749/>
* [ 181110 ] 百度Web前端开发实战案例解析 <https://mp.weixin.qq.com/s/p9HjF-RKdjNOCH2VBNPhIA>: 搜索组件化探索与实践，移动体验标准化建设，基于 Custom  Elements 标准组件化构建 Web 应用，搜索落地页体验技术及应用，如何通过 Lavas 快速构建 PWA 站点
* [ 181106 ] 写给自己看的display: grid布局教程 - 张鑫旭 <https://www.zhangxinxu.com/wordpress/2018/11/display-grid-css-css3/>
* [ 181107 ] Beyond console.log() <https://medium.com/@mattburgess/beyond-console-log-2400fdf4a9d8> `console.table()`, `%c`, `console.assert()`, etc.
* [ 181112 ] Cesium <https://github.com/AnalyticalGraphicsInc/cesium> <iframe src="http://258i.com/gbtn.html?user=AnalyticalGraphicsInc&repo=cesium&type=star&count=true" frameborder="0" scrolling="0" width="105px" height="20px"></iframe>
* [ 181113 ] 如何监控网页崩溃？<https://juejin.im/entry/5be158116fb9a049c6434f4a>
...
* [ 180501 ] JS检测PNG图片是否有透明背景、抠图等相关处理 <https://www.zhangxinxu.com/wordpress/2018/05/canvas-png-transparent-background-detect/>
* [ 170903 ] 机器学习的方法来帮助进行大图可视化 <http://jackieanxis.coding.me/2017/09/03/机器学习的方法来帮助进行大图可视化/> 图谱美观指标
* [ 181108 ] React hooks都是数组，没那么神秘 <https://mp.weixin.qq.com/s/KPgGUjMjpTK3fA1Zjw5MNA> 比如：`useState()`增强了Pure Component的能力，支持简单state
* [ 181105 ] 纯 CSS 实现多行文字截断 <https://mp.weixin.qq.com/s/hWfL0yg2aKr0Xb1qr33h8w> `float + 相对定位`方案的思路很好
* [ 181106 ] 从 React 谈 Web UI 开发 <https://mp.weixin.qq.com/s/YLanebZ85h5cnmjvfBKFxg>
* [ 181102 ] 在Chrome 70中体验WebAssembly线程 <https://mp.weixin.qq.com/s/6nbMHFdRW_BwqQFVQtYUbg>
* [ 181102 ] 富文本编辑器的技术演进之路 <https://mp.weixin.qq.com/s/PyXpfiZ-PiP8S5pQcHRZng>
* [ 181104 ] `twgl` - <https://github.com/greggman/twgl.js/> webgl的底层封装库
* [ 181107 ] Git飞行规则(Flight Rules) - <https://github.com/k88hudson/git-flight-rules/blob/master/README_zh-CN.md>
* [ 181101 ] 谷歌终于开源`BERT`代码：3 亿参数量，机器之心全面解读 <https://www.toutiao.com/a6618799680815890951/> github - TensorFlow code and pre-trained models for BERT: <https://github.com/google-research/bert> BERT是一种模型，Google开源了BERT模型的Tensorflow实现代码
* [ 181010 ] An introduction to using tcpdump at the Linux command line <https://opensource.com/article/18/10/introduction-tcpdump>
        $ sudo tcpdump -i any
        $ sudo tcpdump -i any -c5 icmp
        $ sudo tcpdump -i any -c5 -nn host 54.204.39.132
        $ sudo tcpdump -i any -c10 -nn -A port 80
* [ 181108 ] 【人物志】美团首席科学家夏华夏：不断突破边界的程序人生 <https://mp.weixin.qq.com/s/VsBilRVaeCroG6x-6VpOXg>
* [ 181107 ] 小程序斩获世界级大奖，我们想和你分享 <https://mp.weixin.qq.com/s/7JdoQv5foumG9cYmDfXEDA>
* [ 181107 ] 大咖谈 | GIS，当担负智慧城市操作系统之重任 <https://mp.weixin.qq.com/s/72monZHX_G-g_wXY53tZDw>
* [ 181106 ] 哈佛大学推荐—20个使人积极乐观的思维方式（建议为孩子收藏 <https://www.toutiao.com/a6620557551333278212/>
* [ 180727 ] JS uint8Array转String <https://blog.csdn.net/lightupheaven/article/details/81240862>
* [ 181106 ] 所见即所得的地图你需要吗 <https://mp.weixin.qq.com/s/ZkwYew49HbDQ7VAu5ya-4Q>
* [ 181105 ] 双语｜美国独立宣言全文（中英文对照）<https://www.toutiao.com/a6620395242770137603/>
* [ 181031 ] V8 release v7.1 <https://v8.dev/blog/v8-release-71> The `Intl.RelativeTimeFormat` API等
        rtf.format(-1, 'day');
        // → 'yesterday'
        ...
        rtf.format(1, 'week');
        // → 'next week'
* [ 181029 ] The Definitive TypeScript Guide <https://www.sitepen.com/blog/2018/10/29/update-the-definitive-typescript-guide/>
...
* [ 181101 ] nVidia AI系统，自动P图、P视频、P音频 <https://weibo.com/1642634100/H0Ainr1kC>
* [ 181028 ] 灵活文档：通过上下文可视化链接文本和表格数据来帮助文档阅读 <http://vis.pku.edu.cn/blog/elastic/> 
* [ 181101 ] Interactive UI component dev & test: React, React Native, Vue, Angular, Ember <https://github.com/storybooks/storybook> <https://storybook.js.org> [ from 崔鹏程 ]
* [ 181023 ] Is WebAssembly faster than JavaScript? <https://lemire.me/blog/2018/10/23/is-webassembly-faster-than-javascript/>
    * 文件体积更大，低速网络下不适合
    * 若本地有缓存，那么相比js代码，加载速度更快，不过也并不明显
    * 执行过程中，WebAssembly即使充分优化后，通常也比js慢。同时浏览器支持也还不好
    总的来说，目前使用WebAssembly仍然不够成熟
* [ 181020 ] Playing Mortal Kombat with TensorFlow.js. Transfer learning and data augmentation <https://blog.mgechev.com/2018/10/20/transfer-learning-tensorflow-js-data-augmentation-mobile-net/> 使用TensorFlow.js，迁移学习
* [ 181023 ] Node v11.0.0 <https://nodejs.org/en/blog/release/v11.0.0/> 使用V8 7.0；fs.read()需要有callback，去除fs.SyncWriteStream；等等
* [ 181102 ] 30 Seconds of CSS - A curated collection of useful CSS snippets you can understand in 30 seconds or less. <https://30-seconds.github.io/30-seconds-of-css/> 30秒能看懂的css有用片段 <https://github.com/30-seconds/30-seconds-of-css> 
* [ 181102 ] 30 Seconds of Interviews <https://30secondsofinterviews.org>
* [ 181102 ] 30 Seconds of React <https://github.com/30-seconds/30-seconds-of-react> 还在开发中，欢迎加入贡献
* [ 181024 ] Introducing `Squirrelly`: a fast, lightweight, and simple JS template engine <https://hackernoon.com/introducing-squirrelly-a-fast-lightweight-and-simple-js-template-engine-70a873d765c9>
* [ 181102 ] `face-api.js` - 使用Tensorflow.js，在浏览器中进行人脸检测和识别 <https://github.com/justadudewhohacks/face-api.js>
* [ 181102 ] `Irondb` -  A relentless key-value store for the browser <https://github.com/gruns/irondb>

        $ npm install iron-db --save
...
* [ 181101 ] 【基本功】深入剖析Swift性能优化 <https://mp.weixin.qq.com/s/U95QmOOjeXkk-yC23cuZCQ>
* [ 181018 ] 美团点评基于 Flink 的实时数仓建设实践 <https://mp.weixin.qq.com/s/PJmdXkdUE5gtzcYAgAM8wQ>
* [ 181031 ] 如何在 Linux 中一次重命名多个文件 - mmv <https://www.toutiao.com/a6618515822308491783/>
* [ 181101 ] 【Nginx源码研究】内存管理部分 <https://segmentfault.com/a/1190000016865311>
* 跨平台桌面应用相关Topics
    两大框架 - 基于Nodejs + Chromium的跨平台桌面应用解决方案：
    * `electron` - <https://github.com/electron/electron> 
    * `nwjs` - <https://github.com/nwjs/nw.js>
    一站式跨平台构建基础设施：
    * `mono` - <https://www.winehq.org> 支持在多种POSIX-compliant的OS( Linux, macOS, BSD等)上运行Windows应用的兼容层
    * `wine` - <https://www.mono-project.com> mono目标是创建一系列匹配ECMA标准（Ecma-334和Ecma-335）的.NET工具，包括C#编译器和通用语言架构，可以认为其提供了具有跨平台能力的.NET框架
    打包工具：
...
> 杂谈
* [ 181031 ] 金庸：这就是中国的未来！ <https://mp.weixin.qq.com/s/Zvmg3capCfxVIsVs-mJilg>
* [ 181031 ] 前端开发是否会被代替？  <https://www.wukong.com/answer/6618418253175718151/>
