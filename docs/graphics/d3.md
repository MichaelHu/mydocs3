...
* site: <https://d3js.org>
* github: <https://github.com/d3/d3> <iframe src="https://ghbtns.com/github-btn.html?user=d3&repo=d3&type=star&count=true" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>  
...
* 一个`有底蕴`的可视化库，作者`Mike Bostock`输出许多开创性的关于可视化的文章
