...
> <img src="./svg/d3-logo.svg" style="height: 30px;"> `Data-Driven Documents` - `D3`
...
* site: <https://d3js.org>
* github: <https://github.com/d3/d3> <iframe src="http://258i.com/gbtn.html?user=d3&repo=d3&type=star&count=true" frameborder="0" scrolling="0" width="170px" height="20px"></iframe>  
...
* `React + D3`: <http://numberpicture.com/library> React的D3组件，有公开的，也有私有的，至少展示了React和D3的配合
* `RaphaelJS`: 支持IE6+，有更好的兼容性 <ref://./raphaeljs.md.html>
...
* 一个`有底蕴`的可视化库，多年来持续保持更新，作者`Mike Bostock`输出许多开创性的关于可视化的文章
...
* `5.0.0( RC4 )` [ 180314 ]
* `4.x.x` - 4.13.0 [ latest 180129 ]
    * 使用`ES2015+`的风格编写
    * 可分模块按需import，具体可以参考`apollo`项目 <ref://../hugeapp/apollo-hugeapp.md.html>
    * 分模块引入时，注意针对`d3.event`的特殊处理，也可参考apollo项目
* `3.x.x`
