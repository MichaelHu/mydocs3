...
@import "http://static.didialift.com/pinche/css/animate.min.css";
</style>
    ...
    @[data-script="javascript editable"](function(){
        ...
        d3.select('#test_3_btn_1').on('click', function(){
            ...
            var td = tr.selectAll('td')
                ...
                .style('background-color', function(){ return fly.randomColor(1); })
                .style('color', function(){ return fly.randomColor(1); })
                ;
...
辅助数据可视化的相关计算，`输入域`和`输出`范围的`映射`。



### .range([interval[, padding]])
...
<div class="test-console"></div>
    ...
    @[data-script="javascript editable"](function(){
        ...
        d3.select('#test_40_btn_1').on('click', function(){
            ...
            show('Empty Range', ordinal.range());
            append_show('Empty Domain', ordinal.domain());
        ...
        d3.select('#test_40_btn_6').on('click', function(){
            ...
            show('Domain', ordinal.domain());
            append_show('Range', ordinal.range());
            // 8将被添加到domain，并对应range的90
            append_show('ordinal(8)', ordinal(8));
            // 10将被添加到domain，并对应range的100
            append_show('ordinal(10)', ordinal(10));
        ...
        d3.select('#test_40_btn_9').on('click', function(){
            ...
            show('Range', ordinal.range());
            append_show('BandWidth', ordinal.rangeBand());
            append_show('RangeExtent', ordinal.rangeExtent());
...
<div class="test-console"></div>
    ...
    @[data-script="javascript editable"](function(){
        ...
        function showColors( colors ) {
            ...
            // show('Colors: ' + d3.scale.category10().range());
...
如果interpolate为函数，则该函数作为构建路径字符串的接口函数，也即`自定义`interpolate函数。
